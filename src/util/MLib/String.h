...
class String {
public:
    static std::string Join(const std::string& s, const std::vector<std::string>& v); // TODO: Unit test
    static std::vector<std::string> Split(const std::string& subject,
                                          const std::string& search); // TODO: Unit test
    static std::string Before(const std::string& subject, const std::string& search); // TODO: Unit test
    static std::string After(const std::string& subject, const std::string& search); // TODO: Unit test
    ...
    static bool Contains(const std::string& subject, const std::string& search); // TODO: Unit test
    ...
    static size_t Count(const std::string& s, const std::string& key); // TODO: Unit test
    ...
    static std::string Unwrap(const std::string& s, const std::string& lh,
                              const std::string& rh = ""); // TODO: Unit test
    static bool StartsWith(const std::string& s, const std::string& key); // TODO: Unit test
    static bool EndsWith(const std::string& s, const std::string& key); // TODO: Unit test
    static std::string Pad(const std::string& s, size_t len, char pad_char = ' '); // TODO: Unit test
