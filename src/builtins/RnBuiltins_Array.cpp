...
/*****************************************************************************/
void RnBuiltins_Array::array_filter(RnScope* scope, const std::vector<RnObject*>& args,
	RnObject* ret_val)
{
...
/*****************************************************************************/
void RnBuiltins_Array::array_union(RnScope* scope, const std::vector<RnObject*>& args,
	RnObject* ret_val)
{
...
/*****************************************************************************/
void RnBuiltins_Array::array_intersect(RnScope* scope,
