...
public:
    ...
    [[nodiscard]] RnType::Type GetReturnType() const { return _return_type; }

    void SetReturnType(RnType::Type type) { _return_type = type; }

    [[nodiscard]] RnFunction* ToFunction() const override { return _data; }

    [[nodiscard]] RnType::Type GetType() const override { return RnType::RN_FUNCTION; }
