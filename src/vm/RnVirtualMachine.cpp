...
void RnVirtualMachine::RegisterBuiltins() {
    ...
    std::vector<std::tuple<std::string, BuiltinFunction, RnType::Type>> functions = {
        ...
        {"randint", CastToBuiltin(&RnBuiltins_Math::rn_builtin_randint), RnType::RN_INT},
        {"normal", CastToBuiltin(&RnBuiltins_Math::rn_builtin_normal), RnType::RN_ARRAY},
        {"file_size", CastToBuiltin(&RnBuiltins_IO::rn_builtin_file_size), RnType::RN_INT},
        {"file_write", CastToBuiltin(&RnBuiltins_IO::rn_builtin_file_write), RnType::RN_INT},
        ...
        {"to_float", CastToBuiltin(&RnBuiltins_Type::rn_builtin_to_float), RnType::RN_FLOAT},
        {"to_string", CastToBuiltin(&RnBuiltins_Type::rn_builtin_to_string), RnType::RN_STRING},
        {"to_bool", CastToBuiltin(&RnBuiltins_Type::rn_builtin_to_bool), RnType::RN_BOOLEAN},
        {"is_string", CastToBuiltin(&RnBuiltins_Type::rn_builtin_is_string), RnType::RN_BOOLEAN},
        {"is_float", CastToBuiltin(&RnBuiltins_Type::rn_builtin_is_float), RnType::RN_BOOLEAN},
        {"is_array", CastToBuiltin(&RnBuiltins_Type::rn_builtin_is_array), RnType::RN_BOOLEAN},
        {"is_object", CastToBuiltin(&RnBuiltins_Type::rn_builtin_is_object), RnType::RN_BOOLEAN},
        {"is_bool", CastToBuiltin(&RnBuiltins_Type::rn_builtin_is_bool), RnType::RN_BOOLEAN},
        {"is_callable", CastToBuiltin(&RnBuiltins_Type::rn_builtin_is_callable), RnType::RN_BOOLEAN},
        {"is_int", CastToBuiltin(&RnBuiltins_Type::rn_builtin_is_int), RnType::RN_BOOLEAN},
        {"titlecase", CastToBuiltin(&RnBuiltins_String::rn_builtin_titlecase), RnType::RN_STRING},
        {"lower", CastToBuiltin(&RnBuiltins_String::rn_builtin_lower), RnType::RN_STRING},
        {"upper", CastToBuiltin(&RnBuiltins_String::rn_builtin_upper), RnType::RN_STRING},
        {"snakecase", CastToBuiltin(&RnBuiltins_String::rn_builtin_snakecase), RnType::RN_STRING},
        {"str_split", CastToBuiltin(&RnBuiltins_String::rn_builtin_str_split), RnType::RN_STRING},
        {"str_merge", CastToBuiltin(&RnBuiltins_String::rn_builtin_str_merge), RnType::RN_STRING},
        {"str_substr", CastToBuiltin(&RnBuiltins_String::rn_builtin_str_substr), RnType::RN_STRING},
        {"str_startwith", CastToBuiltin(&RnBuiltins_String::rn_builtin_str_startwith), RnType::RN_BOOLEAN},
        {"str_endswith", CastToBuiltin(&RnBuiltins_String::rn_builtin_str_endswith), RnType::RN_BOOLEAN},
        {"str_join", CastToBuiltin(&RnBuiltins_String::rn_builtin_str_join), RnType::RN_STRING},
        {"array_filter", CastToBuiltin(&RnBuiltins_Array::rn_builtin_array_filter), RnType::RN_ARRAY},
        {"array_union", CastToBuiltin(&RnBuiltins_Array::rn_builtin_array_union), RnType::RN_ARRAY},
        {"array_intersect", CastToBuiltin(&RnBuiltins_Array::rn_builtin_array_intersect), RnType::RN_ARRAY},
        {"count", CastToBuiltin(&RnBuiltins_Array::rn_builtin_count), RnType::RN_INT},
        {"array_merge", CastToBuiltin(&RnBuiltins_Array::rn_builtin_array_merge), RnType::RN_ARRAY},
        {"array_push", CastToBuiltin(&RnBuiltins_Array::rn_builtin_array_push), RnType::RN_VOID},
        {"array_pop", CastToBuiltin(&RnBuiltins_Array::rn_builtin_array_pop), RnType::RN_VOID},
        {"array_zeros", CastToBuiltin(&RnBuiltins_Array::rn_builtin_array_zeros), RnType::RN_ARRAY},
        {"array_fill", CastToBuiltin(&RnBuiltins_Array::rn_builtin_array_fill), RnType::RN_ARRAY},
        {"sequence", CastToBuiltin(&RnBuiltins_Array::rn_builtin_sequence), RnType::RN_ARRAY},
